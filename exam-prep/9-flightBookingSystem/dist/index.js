class FlightBookingSystem {
    ...
    addFlight(flightNumber, destination, departureTime, price) {
        const fligthExists = this.flights.some((f) => f.flightNumber === flightNumber);
        if (fligthExists) {
    ...
    cancelBooking(passengerName, flightNumber) {
        const bookingIndex = this.bookings.findIndex((booking) => booking.flightNumber === flightNumber &&
    ...
    showBookings(criteria) {
        ...
        if (criteria === "cheap") {
            ...
            return `Cheap bookings: \n${cheapBookings
                .map((book) => `${book.passengerName} booked for flight ${book.flightNumber}.`)
                .join("\n")}`;
        }
